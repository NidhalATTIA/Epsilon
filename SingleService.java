...
public class SingleService {
    ...
    public static void main(String[] args) {
      ...
      // Annonce A1=new Annonce(1,"WebSite","besoin d Experience de 3ans ","java");
       ...
       // Annonce A2=new Annonce(1, "WebSite","besoin d Experience de 2ans ","angular");
        Annonce A3=new Annonce(5, "WebSiteforbeginners","besoin d Experience de 4ans ");
