 ...
 */
public class JobsBySkillsFXMLController implements Initializable {
    ...
    private Button Complaintsbtn;
      ...
      ServiceFreelancer sf = new ServiceFreelancer();
       ...
       Image card2=null;
       private List <FreelancerSkills> l = null;
       private List <Annonce> la = null;
    /**
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       Image card=null;
        ...
        try {
            ...
            l = ssf.readAll(f.getId());
            for (FreelancerSkills s : l){
            System.out.println(s);
            data.addAll(sa.readAlls(s.getSkill5()));
