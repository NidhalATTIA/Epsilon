 ...
 * @author Arzack
 */
public class SubscriptionFreelancerFXMLController implements Initializable {
         ...
         Listeview.setCellFactory(new Callback<ListView<Annonce>,ListCell<Annonce>>(){
            ...
            public ListCell<Annonce> call(ListView<Annonce> param) {
               ...
               if (free!=null){
                   ...
                   try {
                       sk= ssk.recherche(free.getSkills());
                   } catch (SQLException ex) {
