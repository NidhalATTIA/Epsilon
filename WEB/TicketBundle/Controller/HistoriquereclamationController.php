...
class HistoriquereclamationController extends Controller
{
    ...
    public function readHAction()
    {
        ...
        return $this->render('@Ticket/Historiquereclamation/AfficheH.html.twig', array('Historiquereclamation' => $historique));
    }
    ...
    public function createHAction(Request $request)
    {
        ...
        return $this->render('@Ticket/Historiquereclamation/createH.html.twig', array('f' => $form->createView()));
    }
    ...
    public function editHAction(Request $request, $id)
    {
        ...
        return $this->render('@Ticket/Historiquereclamation/editH.html.twig', array('f' => $form->createView()));
    }
    ...
    public function rechercherHAction(Request $request)
    {
        ...
        return $this->render("@Ticket/Historiquereclamation/rechercherH.html.twig",
    ...
    public function editeAction(Request $request, $id)
    {
        ...
        return $this->render('@Ticket/Historiquereclamation/editE.html.twig', array('f' => $form->createView()));
    }
