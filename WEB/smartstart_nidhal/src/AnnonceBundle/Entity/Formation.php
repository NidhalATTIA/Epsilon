 ...
 * Formation
 *
 * @ORM\Table(name="formation", indexes={@ORM\Index(name="idClient", columns={"idClient"}), @ORM\Index(name="categorie", columns={"idCategorieF"})})
 * @ORM\Entity
 */
class Formation
{
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="idCategorieF", referencedColumnName="id")
     * })
     */
