...
use FormationBundle\Entity\Formationcat;
use FormationBundle\Form\FormationcatType;
...
//$formation1->setDate(\DateTime::createFromFormat('d/m/Y',$a));
        ...
        return $this->render('@Formation/Formation/createFormation.html.twig', array('f' => $form->createView()));
    }
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        return $this->render('@Formation/Formation/updateFormation.html.twig', array('f' => $form->createView()));
    }
    ...
    public function afficheAction(Request $request)
    {
        ...
        return $this->render('@Formation/Formation/afficheFormationClient.html.twig', array("form" => $form->createView(), 'formation' => $formation));
    ...
    /*
        public function detailAction(Request $request, $id)
        {
            ...
            return $this->render('@Formation/Formation/detailFormation.html.twig', array(

                'Titre' => $formation->getTitre(),
                'idCategorief' => $formation->getIdcategorief(),
...
//categorie equivalent formation
//formationcat equivalent annoncecat
    ...
    {
        $formation = $this->getDoctrine()->getRepository(formation::class)->findBy(array('id' => $id));
        return $this->render('@Formation/Formation/detail1Formation.html.twig', array('formation' => $formation));
    }

    public function accepteeAction()
    {
        return $this->render('@Formation/Formation/accepteeFormation.html.twig');
    }
 ...
 /*   public function retourAction()
    ...
    public function listAction(Request $request)
    {
        ...
        return $this->render('@Formation/Formation/listFormation.html.twig',array('list'=>$list));
