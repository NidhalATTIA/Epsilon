...
import Controllers.AjouterFeedbackFXMLController;
   ...
   try {
     ...
     a1 = tache.rechercheAdminByName_Mdp(username.getText(),userpassword.getText());
       c1 = tache.rechercheClientByName_Mdp(username.getText(),userpassword.getText());
        ...
        if (username.getText().isEmpty() ) {
          ...
          //.reponce.setText("Freelancer");
           ServiceAuthentification.fre=f1.getId();
         
            
         URL url = new File("C:/Users/Yasser Bel Haj Ali/Documents/NetBeansProjects/ProjetPi/src/GUI/AccueilFreelancerFXML.fxml").toURI().toURL();
       ...
       //.reponce.setText("Client");
         ServiceAuthentification.cli=c1.getId();
      
       }
        else if(f1.getMotDePass() == null && c1.getMotDePass() == null && a1.getMotDePass()!= null )  {
        
             URL url = new File("C:/Users/Yasser Bel Haj Ali/Documents/NetBeansProjects/ProjetPi/src/GUI/AccueilAdminFXML.fxml").toURI().toURL();
        Parent root = FXMLLoader.load(url);
        entre.getScene().setRoot(root);
        ServiceAuthentification.ad=a1.getID();
