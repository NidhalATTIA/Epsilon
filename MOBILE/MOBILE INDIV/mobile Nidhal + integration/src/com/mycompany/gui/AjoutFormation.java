...
public class AjoutFormation {
    ...
    ComboBox<String> cat1=new ComboBox();
    ...
    for (Formation cf: sff.getlist()){
                       cat1.addItem(cf.getIdClient().getNom_company());
      //  System.out.println(cf.getIdClient().getNom_company());
   // lll = new Label(cf.getIdClient().getNom_company());
    }
    ...
    btn.addActionListener((e)->{
           ...
           // fos_user fos = new fos_user();
                   ...
                   CategorieFormation selectedCategorie = new CategorieFormation();
                    ...
                    fos_user fosselect = new fos_user();
                    fosselect.setNom_company(cat1.getSelectedItem());
                    System.out.println("SelectedItem"+cat1.getSelectedItem());
        ...
        try {
            ...
            sff.ajoutFormation(t);
             ...
             FormationClient tt = new FormationClient();
    ...
    cnt1.add(cat1);cnt1.add(cat);cnt1.add(l1);cnt1.add(tf1);cnt1.add(l2);cnt1.add(ta);cnt1.add(l3);
