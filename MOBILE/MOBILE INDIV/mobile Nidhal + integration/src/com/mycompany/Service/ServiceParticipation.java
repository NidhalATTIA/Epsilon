...
public class ServiceParticipation {
     public void participer(int IdFormation, int IdFreelancer) throws IOException{
        ...
        String url = "http://localhost/SmartStart_test/web/app_dev.php/participerloua?idformation=" + IdFormation + "&id=" + IdFreelancer;
  ...
  /*   public void annuler(int IdFormation, int IdFreelancer) throws IOException{
        ...
        con.setUrl(url);
            ...
            public void actionPerformed(NetworkEvent evt) {
                ...
                try {
                    ...
                    System.out.println(list);
                    if(list==null){
                        Dialog.show("Confirmation", "Vous venez d'annuler votre participation!", "Ok", "Annuler");
                    }else{
                          Dialog.show("Confirmation", "Vous n'êtes pas membre de cete formation ", "Ok", "Annuler");
                    }
    ...
    public void annuler(int IdFormation,int IdFreelancer) throws IOException{
         ConnectionRequest con = new ConnectionRequest();
        String url = "http://localhost/SmartStart_test/web/app_dev.php/annulerparticipation?idformation=" + IdFormation + "&id=" + IdFreelancer;
