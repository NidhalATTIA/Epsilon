...
public class ServiceCategorie {
   ...
   public void ajoutFormation(Categorie r) {
        ConnectionRequest con = new ConnectionRequest();
        String Url = "http://localhost/SmartStart_test/web/app_dev.php/cat/new2?categorier=" + r.getCategorier();
        con.setUrl(Url);
   ...
   public void suppCat(int id) {
        ...
        String Url = "http://localhost/SmartStart_test/web/app_dev.php/deleter/"+id;// création de l'URL
   ...
   public void updatecat(Categorie r) {
        ConnectionRequest con = new ConnectionRequest();// création d'une nouvelle demande de connexion
        String Url = "http://localhost/SmartStart_test/web/app_dev.php/editr/" +id+"?categorier="+r.getCategorier();// création de l'URL
        con.setUrl(Url);// Insertion de l'URL de notre demande de connexion
