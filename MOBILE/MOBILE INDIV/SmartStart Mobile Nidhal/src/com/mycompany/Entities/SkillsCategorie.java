 ...
 * @author Arzack
 */
public class SkillsCategorie {
    private int id,idFreelancer, idSujet;
    private String contenu;

    public SkillsCategorie() {
    }

    public SkillsCategorie(int id,int idSujet,int idFreelancer, String contenu) {
        this.id =id;
    ...
    public SkillsCategorie(int idFreelancer) {
        this.idFreelancer = idFreelancer;
