...
public ArrayList<Categorie> getAllCategorie() {
    ...
    public ArrayList<Ticket> getlist() {
        ...
        con.setUrl("http://localhost/Baltifarah/web/app_dev.php/Ticket/tickets/all1");
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                //listTasks = getListTask(new String(con.getResponseData()));
     ...
     public void ajoutRec(Ticket t) {
        ConnectionRequest con = new ConnectionRequest();
        String Url = "http://localhost:80/Baltifarah/web/app_dev.php/Ticket/ticket/new1?offre=" + t.getOffre();
        con.setUrl(Url);
     ...
     public void suppRec(int id) {
        ...
        String Url = "http://localhost/Baltifarah/web/app_dev.php/Ticket/delete/"+id;// création de l'URL
    ...
    public ArrayList<Ticket> parseListTaskJson(String json){
        ...
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/Baltifarah/web/app_dev.php/Ticket/tickets/find1");  
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
     ...
     public void ajouterTicket(Ticket ticket) {
        ...
        String url = "http://localhost/Baltifarah/web/app_dev.php/Ticket/ticket/new1?"
