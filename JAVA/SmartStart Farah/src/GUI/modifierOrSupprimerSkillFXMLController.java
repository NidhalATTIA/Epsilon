 ...
 * @author LENOVO
 */
public class modifierOrSupprimerSkillFXMLController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(modifierOrSupprimerSkillFXMLController.class.getName()).log(Level.SEVERE, null, ex);
            }
